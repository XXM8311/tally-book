  ...
  <view class="container">
    ...
    <view class="user-card">
      <view class="user-info">
        ...
        <text class="sex">{{ userInfo.sex === '1' ? '男' : userInfo.sex === '0' ? '女' : '未设置' }}</text>
      </view>
    </view>
    ...
    <u-popup :show="showAccountPopup" mode="bottom" @close="showAccountPopup = false" round="16">
      <view class="edit-popup">
        <view class="popup-header">
          <text>账户管理</text>
          <u-icon name="close" size="28" @click="showAccountPopup = false"></u-icon>
        </view>
    ...
    <u-popup :show="showPasswordPopup" mode="bottom" @close="showPasswordPopup = false" round="16">
      <view class="edit-popup">
        <view class="popup-header">
          <text>修改密码</text>
          <u-icon name="close" size="28" @click="showPasswordPopup = false"></u-icon>
        </view>
    ...
    <u-popup :show="showAboutPopup" mode="bottom" @close="showAboutPopup = false" round="16">
      <view class="edit-popup">
        <view class="popup-header">
          <text>关于我们</text>
          <u-icon name="close" size="28" @click="showAboutPopup = false"></u-icon>
        </view>
